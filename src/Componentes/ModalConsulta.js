...
import { Row, Col, Button, Modal, Typography, Form, Input, message, Spin, Drawer, Space, InputNumber, DatePicker, Upload, Select, Tag } from 'antd';
...
class ModalTransaccion extends Component {
    ...
    updateTransaccion = (values) => {
        this.setState({ loading: true })
        axios.put(`${process.env.REACT_APP_API_URL}/turno/update`, {
